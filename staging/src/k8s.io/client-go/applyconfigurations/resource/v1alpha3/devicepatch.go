...
type DevicePatchApplyConfiguration struct {
	...
	Attributes map[resourcev1alpha3.FullyQualifiedName]DeviceAttributeApplyConfiguration `json:"attributes,omitempty"`
...
func (b *DevicePatchApplyConfiguration) WithAttributes(entries map[resourcev1alpha3.FullyQualifiedName]DeviceAttributeApplyConfiguration) *DevicePatchApplyConfiguration {
	if b.Attributes == nil && len(entries) > 0 {
		b.Attributes = make(map[resourcev1alpha3.FullyQualifiedName]DeviceAttributeApplyConfiguration, len(entries))
	}
